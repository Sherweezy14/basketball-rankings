    ...
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
      <div className="h-22 justify-between  lg:max-w-7xl mx-auto px-6 h-20 flex items-center ">
        ...
        <div className="hidden lg:flex  items-center gap-8">
          ...
          {userLoggedIn &&
            hasPermission(userLoggedIn.role, "create_player") && (
              <Link
                to="/createplayer"
                className="bg-purple-700 text-white font-bold px-5 py-2.5 rounded-xl lg:mt-0"
              >
                + Add Player
              </Link>
            )}
        ...
        <div className="lg:hidden bg-white border-t border-slate-200 text-xl px-6 py-4 space-y-4">
          ...
          {userLoggedIn &&
            hasPermission(userLoggedIn.role, "create_player") && (
              <Link
                to="/createplayer"
                className="bg-purple-700 text-white font-bold px-5 py-2.5 rounded-xl"
              >
                + Add Player
              </Link>
            )}
