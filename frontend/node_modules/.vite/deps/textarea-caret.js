...
//#region node_modules/textarea-caret/index.js
var require_textarea_caret = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function() {
		var properties = [
			"direction",
			"boxSizing",
		...
		function getCaretCoordinates(element, position, options) {
			...
			properties.forEach(function(prop) {
				if (isInput && prop === "lineHeight") style.lineHeight = computed.height;
		...
		else if (isBrowser) window.getCaretCoordinates = getCaretCoordinates;
	})();
}));
//#endregion
